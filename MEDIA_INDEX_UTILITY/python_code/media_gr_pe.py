...
def replace_key(key_desc_list, hymn_name, service_id):
    pattern = re.compile(rf"^pe{service_id}.*\.{hymn_name}\..*")
...
def main():
    # Paths - Keeping original for Greek Pentecostarion
    ...
    output_path = "C:/git/ages-alwb-system/net.ages.liturgical.workbench.system/MEDIA_INDEX_UTILITY/output/grPE.html"
    ...
    with open(media_map_path, 'r', encoding='utf-8') as mm:
        for line in mm:
            ...
            try:
                ...
                current_line[2] = alt_text + replace_service(day_desc, service_id, "")
    ...
    with open(output_path, 'w', encoding='utf-8') as out:
        out.write(fs)
    print("Successfully generated grPE.html snippet.")
